defmodule BreakingRaft.RealWorld.NodeTest do
  use ExUnit.Case, async: true
  alias BreakingRaft.RealWorld.Node

  test "it can be created with number and host" do
    assert Node.new(1, "localhost") == %Node{id: 1, host: "localhost", port: 4000}
  end
  ...
  test "node port can be accessed" do
    n = Node.new(3, "foo")
